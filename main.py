...
def setArgs():
    ...
    *************************************************************************
    ...
    parser.add_argument("-data", default= os.path.join('E:/gathering mining/data',cityname, cityname+str(int(scale*100000))+str(time_size)), help="训练集和模型存储目录")
    parser.add_argument("-checkpoint", default= os.path.join('E:/gathering mining/data',cityname, cityname+str(int(scale*100000))+str(time_size),'checkpoint.pt'), help="checkpoint存放目录")
    '''
    *************************************************************************
    神经网络层参数
    *************************************************************************
