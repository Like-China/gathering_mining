...
def set_args():
    ...
    *****************
    '''
    parser.add_argument("-max_train_num", type=int, default=80000000, help='Size of the training set')
    parser.add_argument("-max_val_nums", type=int, default=20000, help="Size of the validation set")
    ...
    *************************************************************************
    ...
    parser.add_argument("-num_layers", type=int, default=4, help="Number of layers in the RNN cell")
    parser.add_argument("-bidirectional", type=bool, default=True, help="True if use bidirectional rnn in encoder")
    parser.add_argument("-hidden_size", type=int, default=128, help="The hidden state size in the RNN cell")
    parser.add_argument("-embedding_size", type=int, default=128, help="The word (cell) embedding size")
